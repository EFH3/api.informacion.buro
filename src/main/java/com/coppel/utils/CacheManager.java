 ...
 /* RESERVED FOR FUTURE USE  private static Object lock = new Object(); */
    static {
        try {
            ...
            Thread threadCleanerUpper = new Thread(
                ...
                public void run() {
                    try {
                        ...
                        while (true) {
                            ...
                            while (keys.hasNext()) {
                                ...
                                if (value.isExpired()) {
                                    ...
                                    System.out.println("ThreadCleanerUpper Corriendo. Se encontró un objeto expirado y se ha eliminado.");
                                }
                            }
                            /**
                             * ***********************************************************************
                             ******* A LRU (least-recently used) or LFU
                             * (least-frequently used) ***** ****** would best
                             * be inserted here *****
                             * ***********************************************************************
                             */
                        ...
                        LOGGER.error("run: Error en Util: " + e.getMessage());
                        /*e.printStackTrace(); se comenta codigo
                        por problemas de vulnerabilidad y se agrega el LOGGER*/
                    }
                    return;
                }
                /* End run method */
            ...
            /*System.out.println("CacheManager.Static Block: " + e); se comenta
            codigo por problemas de vulnerabilidad y se agrega el LOGGER*/
        }
    }
